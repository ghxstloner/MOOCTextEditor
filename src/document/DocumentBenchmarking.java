...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
		...
		long startBasicTime, endBasicTime;
		long startEfficientTime, endEfficientTime;
		double totalTimeSeconds;
		double totalEfficientSeconds;
				...
				numToCheck += increment)
		{
			...
			//Este vendría siendo el caso para el código con el algoritmo "basico"
